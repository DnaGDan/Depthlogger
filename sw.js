const VERSION='pwa-v4.21.4-launch-fix';
const CACHE='depthlogger-'+VERSION;
// GitHub Pages has no index.html at the directory root; cache the actual entry page.
const ASSETS=['./index_pwa_v3.html','./manifest.json','./icon-192.png','./icon-512.png','./exceljs.min.js','./jszip.min.js','./brownfield-logo-data.js?v=4.21.4','./excel-report-v4.js?v=4.21.4','./EXCELJS-LICENSE.txt','./JSZIP-LICENSE.md'];
