...
const ASSETS=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./brownfield_logo.png'];
...
self.addEventListener('fetch',e=>{
  ...
  e.respondWith((async()=>{
    ...
    catch(err){ if(e.request.headers.get('accept')?.includes('text/html')) return caches.match('./index.html'); throw err; }
  })());
});
