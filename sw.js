const VERSION='pwa-v4.5.0';
const CACHE='depthlogger-'+VERSION;
// update to new html name
const ASSETS=['./','./index_pwa_v4.html','./manifest.json','./icon-192.png','./icon-512.png','./exceljs.min.js','./jszip.min.js','./brownfield-logo-data.js?v=4.5.0','./excel-report-v4.js?v=4.5.0','./EXCELJS-LICENSE.txt','./JSZIP-LICENSE.md'];
