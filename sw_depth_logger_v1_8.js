...
const VERSION='v1.8.0'; const CACHE_NAME='depth-logger-'+VERSION;
const ASSETS=['./','./depth_to_water_logger_PWA_IndexedDB_v1.8.0.html','./manifest_depth_logger.webmanifest','./icon-192.png','./icon-512.png'];
